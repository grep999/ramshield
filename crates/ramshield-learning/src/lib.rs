...
impl PatternLearner {
    ...
    ///
    /// ponytail: Heuristic pattern matching. Not verified ML.
    ...
    /// Detect if data matches a known pattern.
    ///
...
/// Evaluation metrics for a candidate ML model.
...
impl EvaluationMetrics {
    /// Return true if the model meets minimum production guardrails.
...
mod tests {
    ...
    #[test]
    fn evaluation_metrics_default_not_production_ready() {
