# Heal Task: Verify ramshield-helper-agent
...
## Task
1. Run `hermes cron run e3652296ba99` to trigger the job immediately.
...
4. Write a verification report to docs/HEAL_LOG.md under "## Verify: ramshield-helper-agent".
