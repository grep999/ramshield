# Heal Task: Verify ramshield-reviewer
...
## Task
1. Run `hermes cron run d72f32a35099` to trigger the job immediately.
...
4. Write a verification report to docs/HEAL_LOG.md under "## Verify: ramshield-reviewer".
